...
| `recordTokenColor` | Writes the AKD and sNIGHT shielded token colors to `tokenColor` and `sNightColor`, purely as a frontend read convenience; unguarded and idempotent |
